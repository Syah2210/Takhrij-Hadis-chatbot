...
- **Gharib al-Hadis :**
  [Huraian perkataan terpilih berdasarkan rujukan - Masukkan JIKA ADA kosa kata sukar]

- **Asbab al-Wurud :**
  [Penjelasan situasi - Masukkan JIKA ADA asbab al-wurud direkodkan]

- **Fiqh al-Hadis :**
  [Huraian komprehensif hukum hakam dan pengajaran dari kitab Syarah - Masukkan JIKA ADA perbincangan fiqh]

- **Nasikh wa al-Mansukh :**
  [Huraian percanggahan/pemansuhan - Masukkan JIKA ADA isu nasikh/mansukh atau mukhtalif]

- **Mukhtalif al-Hadis :**
  [Huraian jalan harmoni atau tarjih jika nampak bercanggah - Masukkan JIKA ADA]
...
- pandanganUlama WAJIB menyenaraikan pandangan ulama terhadap status hadis atau perawinya. Sediakan TEPAT 5 pandangan daripada ulama Ahli Sunnah Wal Jamaah (ASWJ) klasik/muktabar (contoh: Al-Dhahabi, Al-Nawawi, Ibnu Hajar, Al-Hakim, dll). Jika tiada rekod, berikan pandangan umum yang relevan.
`;
...
export interface HadithResult {
  ...
  sumberKitab?: { kitab: string; noHadis: string }[];
  perawiUtama?: string[];
          ...
          properties: {
            ...
            sumberKitab: {
              ...
              items: {
                type: Type.OBJECT,
                properties: {
                  kitab: { type: Type.STRING, description: "Nama sumber kitab (cth: Sunan Tirmizi, Sahih Bukhari)" },
                  noHadis: { type: Type.STRING, description: "Nombor hadis dalam sumber. WAJIB dicari. cth: 2517" }
                },
                required: ["kitab", "noHadis"]
              }
            },
            ...
            pandanganUlama: {
              ...
              items: {
                ...
                properties: {
                  ...
                  aliran: { type: Type.STRING, description: "'ASWJ'" }
                }
              }
            }
          },
...
• Hukum Ulama: Bawakan pandangan ulama ASWJ. Tuliskan nama ulama secara terus (contoh: "Imam al-Nawawi: [huraian]"). JANGAN gunakan label seperti "Pandangan ASWJ".
...
- **Gharib al-Hadis :**
  [Huraian perkataan terpilih berdasarkan rujukan - Masukkan JIKA ADA]

- **Asbab al-Wurud :**
  [Penjelasan situasi - Masukkan JIKA ADA]

- **Fiqh al-Hadis :**
  [Huraian komprehensif hukum hakam dan pengajaran dari kitab Syarah - Masukkan JIKA ADA]

- **Nasikh wa al-Mansukh :**
  [Huraian percanggahan/pemansuhan - Masukkan JIKA ADA]
